...
class Fooman_EmailAttachments_Model_Order_Creditmemo extends Mage_Sales_Model_Order_Creditmemo
{
    ...
    public function sendEmail($notifyCustomer=true, $comment='')
    {
        ...
        if(Mage::getStoreConfig('sales_email/creditmemo/attachpdf',$this->getStoreId())){
            ...
            $mailTemplate = Mage::helper('emailattachments')->addAttachment($pdf,$mailTemplate,Mage::helper('sales')->__('Credit Memo')."_".$this->getIncrementId());
        }
